...
2.  In addition, unlike the original experiment that took place in a
    ...
    implementing the two strategies during the 4 training trials.
...
```{r plot pilot a, include=T, warning=FALSE, message=FALSE, echo = T}
library(patchwork)

reappraisal_plot <- ggplot(pilot_a_tidy, 
       aes(x="", 
           y=percent_reappraisal, 
           fill=intensity)) +
  geom_bar(stat="identity", width=1) +
  coord_polar("y", start=0) +
  labs(title = "Reappraisal") +
  scale_color_manual(values = c("#E24263", "#408F8A", "#ED6F31", "#401959")) +
  scale_fill_manual(values = c("#E24263", "#408F8A", "#ED6F31", "#401959")) +
  theme_void()
  
distraction_plot <- ggplot(pilot_a_tidy, 
       aes(x="", 
           y=percent_distraction, 
           fill=intensity)) +
  geom_bar(stat="identity", width=1) +
  coord_polar("y", start=0) +
  labs(title = "Distraction")  +
  scale_color_manual(values = c("#E24263", "#408F8A", "#ED6F31", "#401959")) +
  scale_fill_manual(values = c("#E24263", "#408F8A", "#ED6F31", "#401959")) +
  theme_void()
  
reappraisal_plot + distraction_plot + plot_layout(ncol=2)
```
...
reappraisal_plot <- ggplot(pilot_b_tidy, 
       aes(x="", 
           y=percent_reappraisal, 
           fill=intensity)) +
  geom_bar(stat="identity", width=1) +
...
distraction_plot <- ggplot(pilot_b_tidy, 
       aes(x="", 
           y=percent_distraction, 
           fill=intensity)) +
  geom_bar(stat="identity", width=1) +
